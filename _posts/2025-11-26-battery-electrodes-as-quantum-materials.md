...
This post summarizes a recent perspective in *Physical Review Materials* <d-cite key="wright2025"></d-cite> in which we review how alkali-ion (de)insertion has been used to alter spin states, induce charge ordering, and drive transitions between insulating, metallic, and magnetically frustrated phases across a range of battery electrode materials.
